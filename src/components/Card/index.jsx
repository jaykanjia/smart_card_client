...
const Card = ({ data }) => {
    return (
        <div className="bg-white dark:bg-[#111] border border-[#6a6a6a] grid sm:grid-cols-2 items-center w-full aspect-[5/3] shadow-2xl rounded-lg p-4 mx-auto justify-center">
