...
const Template = () => {
  return (
    <div className="max-w-7xl m-auto bg-light-500 dark:bg-dark-700 p-[10px_20px]">
        ...
        <div className="flex flex-col rounded-xl p-3 justify-start mt-[20px]">
          ...
          >
            {socialLinks.map((item) => {
              return (
                <div className="p-3 mr-[15px] inline-block bg-light-300 dark:bg-dark-500 rounded-[20px]">
                  <Image
                    src={item.icon}
                    width={45}
                    height={45}
            ...
            return (
              <div className="flex p-3 rounded-xl">
                <div className="bg-light-300 dark:bg-dark-500  p-3 rounded-[20px]">
                  <Image
                    className='invert opacity-50 dark:invert-0'
                    src={item.icon}
                    height={30}
                    width={30}
                  />
