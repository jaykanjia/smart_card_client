    ...
    <div className="max-w-7xl m-auto bg-[#222222] p-[10px_20px]">
      ...
      <div>
        <div className="flex flex-col rounded-[10px] p-[10px] justify-start mt-[20px]">
          ...
          <div className={`whitespace-nowrap overflow-y-hidden overflow-x-auto ${styles.socialIcons}` }>
            <div className="p-[10px] mr-[15px] inline-block bg-[#323f4b] rounded-[20px]">
              <Image src="/images/facebook.png" width={45} height={45} />
            </div>
            <div className="p-[10px] mr-[15px] inline-block bg-[#323f4b] rounded-[20px]">
              <Image src="/images/linkedin.png" width={45} height={45} />
            </div>
            <div className="p-[10px] mr-[15px] inline-block bg-[#323f4b] rounded-[20px]">
              <Image src="/images/instagram.png" width={45} height={45} />
            </div>
            <div className="p-[10px] mr-[15px] inline-block bg-[#323f4b] rounded-[20px]">
              <Image src="/images/skype.png" width={45} height={45} />
            </div>
            <div className="p-[10px] mr-[15px] inline-block bg-[#323f4b] rounded-[20px]">
              <Image src="/images/twitter.png" width={45} height={45} />
            </div>
            <div className="p-[10px] mr-[15px] inline-block bg-[#323f4b] rounded-[20px]">
              <Image src="/images/whatsapp.png" width={45} height={45} />
            </div>
          </div>
        </div>
        <div>
          <div className="flex p-[10px] rounded-[10px]">
            <div className="bg-[#323f4b] p-[10px] rounded-[20px]">
              <Image src="/images/phone.png" height={30} width={30} />
            </div>
          ...
          <div className="flex p-[10px] rounded-[10px]">
            <div className="bg-[#323f4b] p-[10px] rounded-[20px]">
              <Image src="/images/mail.png" height={30} width={30} />
            </div>
            <div className="p-[0px_10px]">
          ...
          <div className="flex p-[10px] rounded-[10px]">
            <div className="bg-[#323f4b] p-[10px] rounded-[20px]">
              <Image src="/images/address.png" height={30} width={30} />
            </div>
            <div className="p-[0px_10px]">
          ...
          <div className="p-[10px] rounded-[10px] flex ">
            <div>
              <div className="bg-[#323f4b] w-[50px] h-[50px] p-[10px] rounded-[20px]">
                <Image src="/images/weblink.png" height={30} width={30} />
              </div>
            </div>
            <div className="p-[0px_10px]">
